...
class GetCatalogItemResponseCollectionWithIncludedSectionLinks(ModelNormal):
    ...
    def _from_openapi_data(cls, _self, *args, **kwargs):  # noqa: E501
        """GetCatalogItemResponseCollectionWithIncludedSectionLinks - a model defined in OpenAPI
