...
class GetCatalogVariantResponseCollectionDataInnerAttributes(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GetCatalogVariantResponseCollectionDataInnerAttributes - a model defined in OpenAPI
