...
class CatalogCategoryCreateQuery(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['CatalogCategoryCreateQueryResourceObject']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'CatalogCategoryCreateQueryResourceObject': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'CatalogCategoryCreateQueryResourceObject': ...
