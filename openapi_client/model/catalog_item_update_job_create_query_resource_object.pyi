...
class CatalogItemUpdateJobCreateQueryResourceObject(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def type() -> typing.Type['CatalogItemBulkUpdateJobEnum']:
                return CatalogItemBulkUpdateJobEnum
            ...
            class attributes(
                                ...
                                class properties:
                                    ...
                                    class data(
                                        ...
                                        class MetaOapg:
                                            ...
                                            @staticmethod
                                            def items() -> typing.Type['CatalogItemUpdateQueryResourceObject']:
                                                return CatalogItemUpdateQueryResourceObject
                                    
                                        def __new__(
                                            cls,
                                            _arg: typing.Union[typing.Tuple['CatalogItemUpdateQueryResourceObject'], typing.List['CatalogItemUpdateQueryResourceObject']],
                                        ...
                                        def __getitem__(self, i: int) -> 'CatalogItemUpdateQueryResourceObject':
                ...
                def __new__(
                    cls,
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    items: typing.Union[MetaOapg.properties.items, dict, frozendict.frozendict, ],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                    **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                ) -> 'attributes':
                    return super().__new__(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["type"]) -> 'CatalogItemBulkUpdateJobEnum': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["type"]) -> 'CatalogItemBulkUpdateJobEnum': ...
