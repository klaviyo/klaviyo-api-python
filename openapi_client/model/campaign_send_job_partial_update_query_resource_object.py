...
class CampaignSendJobPartialUpdateQueryResourceObject(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def type() -> typing.Type['CampaignSendJobEnum']:
                return CampaignSendJobEnum
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["type"]) -> 'CampaignSendJobEnum': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["type"]) -> 'CampaignSendJobEnum': ...
