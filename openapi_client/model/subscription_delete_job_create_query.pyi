...
class SubscriptionDeleteJobCreateQuery(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['SubscriptionDeleteJobCreateQueryResourceObject']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'SubscriptionDeleteJobCreateQueryResourceObject': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'SubscriptionDeleteJobCreateQueryResourceObject': ...
