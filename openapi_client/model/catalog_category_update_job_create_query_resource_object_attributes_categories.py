...
class CatalogCategoryUpdateJobCreateQueryResourceObjectAttributesCategories(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """CatalogCategoryUpdateJobCreateQueryResourceObjectAttributesCategories - a model defined in OpenAPI
