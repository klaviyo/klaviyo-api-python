...
class CatalogVariantCreateJobCreateQuery(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['CatalogVariantCreateJobCreateQueryResourceObject']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'CatalogVariantCreateJobCreateQueryResourceObject': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'CatalogVariantCreateJobCreateQueryResourceObject': ...
