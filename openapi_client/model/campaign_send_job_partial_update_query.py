...
class CampaignSendJobPartialUpdateQuery(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['CampaignSendJobPartialUpdateQueryResourceObject']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'CampaignSendJobPartialUpdateQueryResourceObject': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'CampaignSendJobPartialUpdateQueryResourceObject': ...
