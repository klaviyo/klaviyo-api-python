...
class CatalogVariantCreateQueryResourceObjectRelationshipsItem(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """CatalogVariantCreateQueryResourceObjectRelationshipsItem - a model defined in OpenAPI
