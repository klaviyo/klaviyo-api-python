...
def lazy_import():
    ...
    globals()['ServerBISSubscriptionCreateQueryResourceObject'] = ServerBISSubscriptionCreateQueryResourceObject


class ServerBISSubscriptionCreateQuery(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (ServerBISSubscriptionCreateQueryResourceObject,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ServerBISSubscriptionCreateQuery - a model defined in OpenAPI
