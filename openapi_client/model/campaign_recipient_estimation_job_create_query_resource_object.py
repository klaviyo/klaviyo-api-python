...
class CampaignRecipientEstimationJobCreateQueryResourceObject(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def type() -> typing.Type['CampaignRecipientEstimationJobEnum']:
                return CampaignRecipientEstimationJobEnum
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["type"]) -> 'CampaignRecipientEstimationJobEnum': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["type"]) -> 'CampaignRecipientEstimationJobEnum': ...
