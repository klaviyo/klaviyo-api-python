...
def lazy_import():
    ...
    globals()['STOScheduleOptions'] = STOScheduleOptions
...
class SendStrategySubObject(ModelNormal):
    ...
    def _from_openapi_data(cls, method, *args, **kwargs):  # noqa: E501
        ...
        Args:
            method (str): Describes the shape of the options object. Allowed values: ['static', 'throttled', 'immediate', 'smart_send_time']
