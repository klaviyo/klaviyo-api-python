...
class ProfileMergeQueryResourceObject(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def type() -> typing.Type['ProfileMergeEnum']:
                return ProfileMergeEnum
            ...
            class relationships(
                ...
                def __new__(
                    cls,
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    profiles: typing.Union[MetaOapg.properties.profiles, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
                    _configuration: typing.Optional[schemas.Configuration] = None,
                    **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                ) -> 'relationships':
                    return super().__new__(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["type"]) -> 'ProfileMergeEnum': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["type"]) -> 'ProfileMergeEnum': ...
