...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_catalog_item_relationships_categories_oapg(
        self,
...
class DeleteCatalogItemRelationshipsCategories(BaseApi):
    ...
    def delete_catalog_item_relationships_categories(
        ...
        return self._delete_catalog_item_relationships_categories_oapg(
            body=body,
