...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_catalog_item_relationships_categories_oapg(
        self,
...
class GetCatalogItemRelationshipsCategories(BaseApi):
    ...
    def get_catalog_item_relationships_categories(
        ...
        return self._get_catalog_item_relationships_categories_oapg(
