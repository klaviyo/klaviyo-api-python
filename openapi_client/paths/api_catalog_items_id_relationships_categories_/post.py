...
# body param
SchemaForRequestBodyApplicationJson = CatalogItemCategoryOp


request_body_catalog_item_category_op = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_catalog_item_relationships_categories_oapg(
        self,
    ...
    def _create_catalog_item_relationships_categories_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalog_item_category_op.serialize(body, content_type)
...
class CreateCatalogItemRelationshipsCategories(BaseApi):
    ...
    def create_catalog_item_relationships_categories(
        ...
        return self._create_catalog_item_relationships_categories_oapg(
            body=body,
