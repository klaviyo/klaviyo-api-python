...
# body param
SchemaForRequestBodyApplicationJson = CampaignSendJobPartialUpdateQuery


request_body_campaign_send_job_partial_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_campaign_send_job_oapg(
        self,
    ...
    def _update_campaign_send_job_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_send_job_partial_update_query.serialize(body, content_type)
...
class UpdateCampaignSendJob(BaseApi):
    ...
    def update_campaign_send_job(
        ...
        return self._update_campaign_send_job_oapg(
            body=body,
