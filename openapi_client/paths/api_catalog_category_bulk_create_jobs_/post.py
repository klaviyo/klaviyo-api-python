...
# body param
SchemaForRequestBodyApplicationJson = CatalogCategoryCreateJobCreateQuery


request_body_catalog_category_create_job_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _spawn_create_categories_job_oapg(
        self,
    ...
    def _spawn_create_categories_job_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalog_category_create_job_create_query.serialize(body, content_type)
...
class SpawnCreateCategoriesJob(BaseApi):
    ...
    def spawn_create_categories_job(
        ...
        return self._spawn_create_categories_job_oapg(
            body=body,
