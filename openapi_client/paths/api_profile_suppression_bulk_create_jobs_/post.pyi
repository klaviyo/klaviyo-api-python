...
# body param
SchemaForRequestBodyApplicationJson = SuppressionCreateJobCreateQuery


request_body_suppression_create_job_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _suppress_profiles_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_suppression_create_job_create_query.serialize(body, content_type)
...
class SuppressProfiles(BaseApi):
    ...
    def suppress_profiles(
        ...
        return self._suppress_profiles_oapg(
            body=body,
