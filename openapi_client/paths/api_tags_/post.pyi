...
# body param
SchemaForRequestBodyApplicationJson = TagCreateQuery


request_body_tag_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_tag_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_create_query.serialize(body, content_type)
