...
# body param
SchemaForRequestBodyApplicationJson = SubscriptionDeleteJobCreateQuery


request_body_subscription_delete_job_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _unsubscribe_profiles_oapg(
        self,
    ...
    def _unsubscribe_profiles_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_subscription_delete_job_create_query.serialize(body, content_type)
...
class UnsubscribeProfiles(BaseApi):
    ...
    def unsubscribe_profiles(
        ...
        return self._unsubscribe_profiles_oapg(
            body=body,
