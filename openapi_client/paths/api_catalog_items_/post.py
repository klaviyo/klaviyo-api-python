...
# body param
SchemaForRequestBodyApplicationJson = CatalogItemCreateQuery


request_body_catalog_item_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_catalog_item_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalog_item_create_query.serialize(body, content_type)
...
class CreateCatalogItem(BaseApi):
    ...
    def create_catalog_item(
        ...
        return self._create_catalog_item_oapg(
            body=body,
