...
# body param
SchemaForRequestBodyApplicationJson = CatalogCategoryUpdateQuery


request_body_catalog_category_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_catalog_category_oapg(
        self,
    ...
    def _update_catalog_category_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalog_category_update_query.serialize(body, content_type)
...
class UpdateCatalogCategory(BaseApi):
    ...
    def update_catalog_category(
        ...
        return self._update_catalog_category_oapg(
            body=body,
