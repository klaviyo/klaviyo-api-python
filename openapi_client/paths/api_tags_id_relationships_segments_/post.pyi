...
# body param
SchemaForRequestBodyApplicationJson = TagSegmentOp


request_body_tag_segment_op = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_tag_relationships_segments_oapg(
        self,
    ...
    def _create_tag_relationships_segments_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_segment_op.serialize(body, content_type)
...
class CreateTagRelationshipsSegments(BaseApi):
    ...
    def create_tag_relationships_segments(
        ...
        return self._create_tag_relationships_segments_oapg(
            body=body,
