...
# body param
SchemaForRequestBodyApplicationJson = CatalogCategoryCreateQuery


request_body_catalog_category_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_catalog_category_oapg(
        self,
    ...
    def _create_catalog_category_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalog_category_create_query.serialize(body, content_type)
...
class CreateCatalogCategory(BaseApi):
    ...
    def create_catalog_category(
        ...
        return self._create_catalog_category_oapg(
            body=body,
