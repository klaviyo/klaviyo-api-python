...
# body param
SchemaForRequestBodyApplicationJson = TagGroupUpdateQuery


request_body_tag_group_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_tag_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_group_update_query.serialize(body, content_type)
...
class UpdateTagGroup(BaseApi):
    ...
    def update_tag_group(
        ...
        return self._update_tag_group_oapg(
            body=body,
