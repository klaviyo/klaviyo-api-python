...
# body param
SchemaForRequestBodyApplicationJson = DataPrivacyCreateDeletionJobQuery


request_body_data_privacy_create_deletion_job_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _request_profile_deletion_oapg(
        self,
    ...
    def _request_profile_deletion_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_data_privacy_create_deletion_job_query.serialize(body, content_type)
...
class RequestProfileDeletion(BaseApi):
    ...
    def request_profile_deletion(
        ...
        return self._request_profile_deletion_oapg(
            body=body,
