...
# body param
SchemaForRequestBodyApplicationJson = CouponCodeCreateQuery


request_body_coupon_code_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_coupon_code_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_coupon_code_create_query.serialize(body, content_type)
...
class CreateCouponCode(BaseApi):
    ...
    def create_coupon_code(
        ...
        return self._create_coupon_code_oapg(
            body=body,
