...
# body param
SchemaForRequestBodyApplicationJson = CampaignCloneQuery


request_body_campaign_clone_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_campaign_clone_oapg(
        self,
    ...
    def _create_campaign_clone_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_clone_query.serialize(body, content_type)
...
class CreateCampaignClone(BaseApi):
    ...
    def create_campaign_clone(
        ...
        return self._create_campaign_clone_oapg(
            body=body,
