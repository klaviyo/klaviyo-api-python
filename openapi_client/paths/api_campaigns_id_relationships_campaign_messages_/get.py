...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_campaign_relationships_campaign_messages_oapg(
        self,
...
class GetCampaignRelationshipsCampaignMessages(BaseApi):
    ...
    def get_campaign_relationships_campaign_messages(
        ...
        return self._get_campaign_relationships_campaign_messages_oapg(
