...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'fields[coupon]': typing.Union[FieldsCouponSchema, list, tuple, ],
    },
    total=False
)
...
request_query_fields_coupon = api_client.QueryParameter(
    name="fields[coupon]",
    style=api_client.ParameterStyle.FORM,
    schema=FieldsCouponSchema,
)
# Path params
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_coupon_for_coupon_code_oapg(
        self,
...
class GetCouponForCouponCode(BaseApi):
    ...
    def get_coupon_for_coupon_code(
        ...
        return self._get_coupon_for_coupon_code_oapg(
