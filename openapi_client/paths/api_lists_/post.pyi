...
# body param
SchemaForRequestBodyApplicationJson = ListCreateQuery


request_body_list_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_list_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_list_create_query.serialize(body, content_type)
