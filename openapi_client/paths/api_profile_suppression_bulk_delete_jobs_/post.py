...
# body param
SchemaForRequestBodyApplicationJson = SuppressionDeleteJobCreateQuery


request_body_suppression_delete_job_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _unsuppress_profiles_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_suppression_delete_job_create_query.serialize(body, content_type)
...
class UnsuppressProfiles(BaseApi):
    ...
    def unsuppress_profiles(
        ...
        return self._unsuppress_profiles_oapg(
            body=body,
