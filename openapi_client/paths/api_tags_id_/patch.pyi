...
# body param
SchemaForRequestBodyApplicationJson = TagUpdateQuery


request_body_tag_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_tag_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_update_query.serialize(body, content_type)
