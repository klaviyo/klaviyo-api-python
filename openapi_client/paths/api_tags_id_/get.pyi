...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'fields[tag-group]': typing.Union[FieldsTagGroupSchema, list, tuple, ],
...
request_query_fields_tag_group = api_client.QueryParameter(
    name="fields[tag-group]",
    style=api_client.ParameterStyle.FORM,
    schema=FieldsTagGroupSchema,
)
...
class BaseApi(api_client.Api):
    ...
    def _get_tag_oapg(
        ...
        for parameter in (
            request_query_fields_tag_group,
