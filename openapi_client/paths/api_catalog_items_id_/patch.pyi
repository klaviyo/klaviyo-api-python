...
# body param
SchemaForRequestBodyApplicationJson = CatalogItemUpdateQuery


request_body_catalog_item_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_catalog_item_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalog_item_update_query.serialize(body, content_type)
...
class UpdateCatalogItem(BaseApi):
    ...
    def update_catalog_item(
        ...
        return self._update_catalog_item_oapg(
            body=body,
