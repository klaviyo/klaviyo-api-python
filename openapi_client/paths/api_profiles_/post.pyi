...
# body param
SchemaForRequestBodyApplicationJson = ProfileCreateQuery


request_body_profile_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_profile_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_profile_create_query.serialize(body, content_type)
