...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_flow_action_relationships_messages_oapg(
        self,
...
class GetFlowActionRelationshipsMessages(BaseApi):
    ...
    def get_flow_action_relationships_messages(
        ...
        return self._get_flow_action_relationships_messages_oapg(
