...
# body param
SchemaForRequestBodyApplicationJson = CatalogItemUpdateJobCreateQuery


request_body_catalog_item_update_job_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _spawn_update_items_job_oapg(
        self,
    ...
    def _spawn_update_items_job_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalog_item_update_job_create_query.serialize(body, content_type)
...
class SpawnUpdateItemsJob(BaseApi):
    ...
    def spawn_update_items_job(
        ...
        return self._spawn_update_items_job_oapg(
            body=body,
