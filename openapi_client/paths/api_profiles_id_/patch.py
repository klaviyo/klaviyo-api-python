...
# body param
SchemaForRequestBodyApplicationJson = ProfilePartialUpdateQuery


request_body_profile_partial_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_profile_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_profile_partial_update_query.serialize(body, content_type)
