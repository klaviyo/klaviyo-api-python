...
# body param
SchemaForRequestBodyApplicationJson = ProfileMergeQuery


request_body_profile_merge_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _merge_profiles_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_profile_merge_query.serialize(body, content_type)
...
class MergeProfiles(BaseApi):
    ...
    def merge_profiles(
        ...
        return self._merge_profiles_oapg(
            body=body,
