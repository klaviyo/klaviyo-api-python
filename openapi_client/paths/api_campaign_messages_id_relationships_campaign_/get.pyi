...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_campaign_message_relationships_campaign_oapg(
        self,
...
class GetCampaignMessageRelationshipsCampaign(BaseApi):
    ...
    def get_campaign_message_relationships_campaign(
        ...
        return self._get_campaign_message_relationships_campaign_oapg(
