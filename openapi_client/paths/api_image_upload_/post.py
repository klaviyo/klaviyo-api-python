...
from openapi_client.model.image_upload_query import ImageUploadQuery

from . import path

# body param
SchemaForRequestBodyMultipartFormData = ImageUploadQuery
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upload_image_from_file_oapg(
        self,
...
class UploadImageFromFile(BaseApi):
    ...
    def upload_image_from_file(
        ...
        return self._upload_image_from_file_oapg(
            body=body,
