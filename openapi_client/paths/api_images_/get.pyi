...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'fields[image]': typing.Union[FieldsImageSchema, list, tuple, ],
...
request_query_fields_image = api_client.QueryParameter(
    name="fields[image]",
    style=api_client.ParameterStyle.FORM,
    schema=FieldsImageSchema,
)
