...
# body param
SchemaForRequestBodyApplicationJson = ImageCreateQuery


request_body_image_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upload_image_from_url_oapg(
        self,
    ...
    def _upload_image_from_url_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_image_create_query.serialize(body, content_type)
...
class UploadImageFromUrl(BaseApi):
    ...
    def upload_image_from_url(
        ...
        return self._upload_image_from_url_oapg(
            body=body,
