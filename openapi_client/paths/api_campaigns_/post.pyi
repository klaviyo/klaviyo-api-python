...
# body param
SchemaForRequestBodyApplicationJson = CampaignCreateQuery


request_body_campaign_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_campaign_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_create_query.serialize(body, content_type)
...
class CreateCampaign(BaseApi):
    ...
    def create_campaign(
        ...
        return self._create_campaign_oapg(
            body=body,
