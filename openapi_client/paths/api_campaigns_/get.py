...
class IncludeSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def CAMPAIGNMESSAGES(cls):
                return cls("campaign-messages")
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'fields[tag]': typing.Union[FieldsTagSchema, list, tuple, ],
...
request_query_fields_tag = api_client.QueryParameter(
    name="fields[tag]",
    style=api_client.ParameterStyle.FORM,
    schema=FieldsTagSchema,
)
...
class GetCampaigns(BaseApi):
    ...
    def get_campaigns(
        ...
        return self._get_campaigns_oapg(
