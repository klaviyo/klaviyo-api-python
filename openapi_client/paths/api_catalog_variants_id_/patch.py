...
# body param
SchemaForRequestBodyApplicationJson = CatalogVariantUpdateQuery


request_body_catalog_variant_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_catalog_variant_oapg(
        self,
    ...
    def _update_catalog_variant_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalog_variant_update_query.serialize(body, content_type)
...
class UpdateCatalogVariant(BaseApi):
    ...
    def update_catalog_variant(
        ...
        return self._update_catalog_variant_oapg(
            body=body,
