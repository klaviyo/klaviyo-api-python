...
# body param
SchemaForRequestBodyApplicationJson = CatalogItemCreateJobCreateQuery


request_body_catalog_item_create_job_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _spawn_create_items_job_oapg(
        self,
    ...
    def _spawn_create_items_job_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalog_item_create_job_create_query.serialize(body, content_type)
...
class SpawnCreateItemsJob(BaseApi):
    ...
    def spawn_create_items_job(
        ...
        return self._spawn_create_items_job_oapg(
            body=body,
