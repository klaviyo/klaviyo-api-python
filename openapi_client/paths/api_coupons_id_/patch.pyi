...
# body param
SchemaForRequestBodyApplicationJson = CouponUpdateQuery


request_body_coupon_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_coupon_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_coupon_update_query.serialize(body, content_type)
...
class UpdateCoupon(BaseApi):
    ...
    def update_coupon(
        ...
        return self._update_coupon_oapg(
            body=body,
