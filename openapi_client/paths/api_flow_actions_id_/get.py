...
class IncludeSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def FLOWMESSAGES(cls):
                return cls("flow-messages")
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'fields[flow-message]': typing.Union[FieldsFlowMessageSchema, list, tuple, ],
        'fields[flow]': typing.Union[FieldsFlowSchema, list, tuple, ],
...
request_query_fields_flow_message = api_client.QueryParameter(
    name="fields[flow-message]",
    style=api_client.ParameterStyle.FORM,
    schema=FieldsFlowMessageSchema,
)
request_query_fields_flow = api_client.QueryParameter(
    name="fields[flow]",
    style=api_client.ParameterStyle.FORM,
    schema=FieldsFlowSchema,
)
...
class BaseApi(api_client.Api):
    ...
    def _get_flow_action_oapg(
        ...
        for parameter in (
            ...
            request_query_fields_flow_message,
            request_query_fields_flow,
...
class GetFlowAction(BaseApi):
    ...
    def get_flow_action(
        ...
        return self._get_flow_action_oapg(
