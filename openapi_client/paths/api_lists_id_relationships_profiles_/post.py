...
# body param
SchemaForRequestBodyApplicationJson = ListMembersAddQuery


request_body_list_members_add_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_list_relationships_oapg(
        self,
    ...
    def _create_list_relationships_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_list_members_add_query.serialize(body, content_type)
...
class CreateListRelationships(BaseApi):
    ...
    def create_list_relationships(
        ...
        return self._create_list_relationships_oapg(
            body=body,
