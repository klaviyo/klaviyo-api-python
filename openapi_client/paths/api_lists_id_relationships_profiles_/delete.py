...
# body param
SchemaForRequestBodyApplicationJson = ListMembersDeleteQuery


request_body_list_members_delete_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_list_relationships_oapg(
        self,
    ...
    def _delete_list_relationships_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_list_members_delete_query.serialize(body, content_type)
...
class DeleteListRelationships(BaseApi):
    ...
    def delete_list_relationships(
        ...
        return self._delete_list_relationships_oapg(
            body=body,
