...
# body param
SchemaForRequestBodyApplicationJson = CouponCodeUpdateQuery


request_body_coupon_code_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_coupon_code_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_coupon_code_update_query.serialize(body, content_type)
...
class UpdateCouponCode(BaseApi):
    ...
    def update_coupon_code(
        ...
        return self._update_coupon_code_oapg(
            body=body,
