...
# body param
SchemaForRequestBodyApplicationJson = CouponCreateQuery


request_body_coupon_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_coupon_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_coupon_create_query.serialize(body, content_type)
...
class CreateCoupon(BaseApi):
    ...
    def create_coupon(
        ...
        return self._create_coupon_oapg(
            body=body,
