...
class FieldsCampaignMessageSchema(
    schemas.ListSchema
):
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    ...
                    "archived": "ARCHIVED",
                    "audiences": "AUDIENCES",
                    "audiences.included": "AUDIENCES_INCLUDED",
                    "audiences.excluded": "AUDIENCES_EXCLUDED",
                    "send_options": "SEND_OPTIONS",
                    "tracking_options": "TRACKING_OPTIONS",
                    "send_strategy": "SEND_STRATEGY",
                    "send_strategy.method": "SEND_STRATEGY_METHOD",
                    "send_strategy.options_static": "SEND_STRATEGY_OPTIONS_STATIC",
                    "send_strategy.options_static.datetime": "SEND_STRATEGY_OPTIONS_STATIC_DATETIME",
                    "send_strategy.options_static.is_local": "SEND_STRATEGY_OPTIONS_STATIC_IS_LOCAL",
                    "send_strategy.options_static.send_past_recipients_immediately": "SEND_STRATEGY_OPTIONS_STATIC_SEND_PAST_RECIPIENTS_IMMEDIATELY",
                    "send_strategy.options_throttled": "SEND_STRATEGY_OPTIONS_THROTTLED",
                    "send_strategy.options_throttled.datetime": "SEND_STRATEGY_OPTIONS_THROTTLED_DATETIME",
                    "send_strategy.options_throttled.throttle_percentage": "SEND_STRATEGY_OPTIONS_THROTTLED_THROTTLE_PERCENTAGE",
                    "send_strategy.options_sto": "SEND_STRATEGY_OPTIONS_STO",
                    "send_strategy.options_sto.date": "SEND_STRATEGY_OPTIONS_STO_DATE",
                    "created_at": "CREATED_AT",
            ...
            @schemas.classproperty
            def AUDIENCES(cls):
                return cls("audiences")
            
            @schemas.classproperty
            def AUDIENCES_INCLUDED(cls):
                return cls("audiences.included")
            
            @schemas.classproperty
            def AUDIENCES_EXCLUDED(cls):
                return cls("audiences.excluded")
            ...
            @schemas.classproperty
            def SEND_STRATEGY(cls):
                return cls("send_strategy")
            
            @schemas.classproperty
            def SEND_STRATEGY_METHOD(cls):
                return cls("send_strategy.method")
            
            @schemas.classproperty
            def SEND_STRATEGY_OPTIONS_STATIC(cls):
                return cls("send_strategy.options_static")
            
            @schemas.classproperty
            def SEND_STRATEGY_OPTIONS_STATIC_DATETIME(cls):
                return cls("send_strategy.options_static.datetime")
            
            @schemas.classproperty
            def SEND_STRATEGY_OPTIONS_STATIC_IS_LOCAL(cls):
                return cls("send_strategy.options_static.is_local")
            
            @schemas.classproperty
            def SEND_STRATEGY_OPTIONS_STATIC_SEND_PAST_RECIPIENTS_IMMEDIATELY(cls):
                return cls("send_strategy.options_static.send_past_recipients_immediately")
            
            @schemas.classproperty
            def SEND_STRATEGY_OPTIONS_THROTTLED(cls):
                return cls("send_strategy.options_throttled")
            
            @schemas.classproperty
            def SEND_STRATEGY_OPTIONS_THROTTLED_DATETIME(cls):
                return cls("send_strategy.options_throttled.datetime")
            
            @schemas.classproperty
            def SEND_STRATEGY_OPTIONS_THROTTLED_THROTTLE_PERCENTAGE(cls):
                return cls("send_strategy.options_throttled.throttle_percentage")
            
            @schemas.classproperty
            def SEND_STRATEGY_OPTIONS_STO(cls):
                return cls("send_strategy.options_sto")
            
            @schemas.classproperty
            def SEND_STRATEGY_OPTIONS_STO_DATE(cls):
                return cls("send_strategy.options_sto.date")
            ...
            @schemas.classproperty
            def SCHEDULED_AT(cls):
                return cls("scheduled_at")
            ...
            @schemas.classproperty
            def SEND_TIME(cls):
                return cls("send_time")

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple[typing.Union[MetaOapg.items, str, ]], typing.List[typing.Union[MetaOapg.items, str, ]]],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'FieldsCampaignSchema':
        return super().__new__(
            cls,
            _arg,
            _configuration=_configuration,
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'fields[campaign-message]': typing.Union[FieldsCampaignMessageSchema, list, tuple, ],
        'fields[campaign]': typing.Union[FieldsCampaignSchema, list, tuple, ],
        'fields[template]': typing.Union[FieldsTemplateSchema, list, tuple, ],
...
request_query_fields_campaign_message = api_client.QueryParameter(
    name="fields[campaign-message]",
    style=api_client.ParameterStyle.FORM,
    schema=FieldsCampaignMessageSchema,
)
request_query_fields_campaign = api_client.QueryParameter(
    name="fields[campaign]",
    style=api_client.ParameterStyle.FORM,
    schema=FieldsCampaignSchema,
)
request_query_fields_template = api_client.QueryParameter(
    name="fields[template]",
    style=api_client.ParameterStyle.FORM,
    schema=FieldsTemplateSchema,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_campaign_campaign_messages_oapg(
        self,
    ...
    def _get_campaign_campaign_messages_oapg(
        ...
        for parameter in (
            request_query_fields_campaign_message,
            request_query_fields_campaign,
            request_query_fields_template,
...
class GetCampaignCampaignMessages(BaseApi):
    ...
    def get_campaign_campaign_messages(
        ...
        return self._get_campaign_campaign_messages_oapg(
