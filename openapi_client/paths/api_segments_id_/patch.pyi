...
# body param
SchemaForRequestBodyApplicationJson = SegmentPartialUpdateQuery


request_body_segment_partial_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_segment_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_segment_partial_update_query.serialize(body, content_type)
...
class UpdateSegment(BaseApi):
    ...
    def update_segment(
        ...
        return self._update_segment_oapg(
            body=body,
