...
# body param
SchemaForRequestBodyApplicationJson = CampaignPartialUpdateQuery


request_body_campaign_partial_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_campaign_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_partial_update_query.serialize(body, content_type)
...
class UpdateCampaign(BaseApi):
    ...
    def update_campaign(
        ...
        return self._update_campaign_oapg(
            body=body,
