...
# body param
SchemaForRequestBodyApplicationJson = TemplateRenderQuery


request_body_template_render_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_template_render_oapg(
        self,
    ...
    def _create_template_render_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_template_render_query.serialize(body, content_type)
...
class CreateTemplateRender(BaseApi):
    ...
    def create_template_render(
        ...
        return self._create_template_render_oapg(
            body=body,
