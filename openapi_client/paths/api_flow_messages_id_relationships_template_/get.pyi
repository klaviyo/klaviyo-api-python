...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_flow_message_relationships_template_oapg(
        self,
...
class GetFlowMessageRelationshipsTemplate(BaseApi):
    ...
    def get_flow_message_relationships_template(
        ...
        return self._get_flow_message_relationships_template_oapg(
