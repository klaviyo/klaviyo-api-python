...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_catalog_category_relationships_items_oapg(
        self,
...
class UpdateCatalogCategoryRelationshipsItems(BaseApi):
    ...
    def update_catalog_category_relationships_items(
        ...
        return self._update_catalog_category_relationships_items_oapg(
            body=body,
