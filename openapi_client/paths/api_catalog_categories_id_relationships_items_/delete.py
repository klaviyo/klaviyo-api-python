...
# body param
SchemaForRequestBodyApplicationJson = CatalogCategoryItemOp


request_body_catalog_category_item_op = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_catalog_category_relationships_items_oapg(
        self,
    ...
    def _delete_catalog_category_relationships_items_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalog_category_item_op.serialize(body, content_type)
...
class DeleteCatalogCategoryRelationshipsItems(BaseApi):
    ...
    def delete_catalog_category_relationships_items(
        ...
        return self._delete_catalog_category_relationships_items_oapg(
            body=body,
