...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_catalog_category_relationships_items_oapg(
        self,
...
class CreateCatalogCategoryRelationshipsItems(BaseApi):
    ...
    def create_catalog_category_relationships_items(
        ...
        return self._create_catalog_category_relationships_items_oapg(
            body=body,
