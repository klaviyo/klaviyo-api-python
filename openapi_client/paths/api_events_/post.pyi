...
# body param
SchemaForRequestBodyApplicationJson = EventCreateQueryV2


request_body_event_create_query_v2 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_event_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_event_create_query_v2.serialize(body, content_type)
