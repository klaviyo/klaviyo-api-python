...
# body param
SchemaForRequestBodyApplicationJson = ServerBISSubscriptionCreateQuery


request_body_server_bis_subscription_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_back_in_stock_subscription_oapg(
        self,
    ...
    def _create_back_in_stock_subscription_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_server_bis_subscription_create_query.serialize(body, content_type)
...
class CreateBackInStockSubscription(BaseApi):
    ...
    def create_back_in_stock_subscription(
        ...
        return self._create_back_in_stock_subscription_oapg(
            body=body,
