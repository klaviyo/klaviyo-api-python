...
# body param
SchemaForRequestBodyApplicationJson = TagFlowOp


request_body_tag_flow_op = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_tag_relationships_flows_oapg(
        self,
    ...
    def _create_tag_relationships_flows_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_flow_op.serialize(body, content_type)
...
class CreateTagRelationshipsFlows(BaseApi):
    ...
    def create_tag_relationships_flows(
        ...
        return self._create_tag_relationships_flows_oapg(
            body=body,
