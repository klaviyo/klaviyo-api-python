...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_campaign_message_relationships_template_oapg(
        self,
...
class GetCampaignMessageRelationshipsTemplate(BaseApi):
    ...
    def get_campaign_message_relationships_template(
        ...
        return self._get_campaign_message_relationships_template_oapg(
