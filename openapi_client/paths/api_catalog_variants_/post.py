...
# body param
SchemaForRequestBodyApplicationJson = CatalogVariantCreateQuery


request_body_catalog_variant_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_catalog_variant_oapg(
        self,
    ...
    def _create_catalog_variant_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalog_variant_create_query.serialize(body, content_type)
...
class CreateCatalogVariant(BaseApi):
    ...
    def create_catalog_variant(
        ...
        return self._create_catalog_variant_oapg(
            body=body,
