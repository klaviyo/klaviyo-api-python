...
# body param
SchemaForRequestBodyApplicationJson = CampaignMessagePartialUpdateQuery


request_body_campaign_message_partial_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_campaign_message_oapg(
        self,
    ...
    def _update_campaign_message_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_message_partial_update_query.serialize(body, content_type)
...
class UpdateCampaignMessage(BaseApi):
    ...
    def update_campaign_message(
        ...
        return self._update_campaign_message_oapg(
            body=body,
