...
# body param
SchemaForRequestBodyApplicationJson = CampaignSendJobCreateQuery


request_body_campaign_send_job_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_campaign_send_job_oapg(
        self,
    ...
    def _create_campaign_send_job_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_send_job_create_query.serialize(body, content_type)
...
class CreateCampaignSendJob(BaseApi):
    ...
    def create_campaign_send_job(
        ...
        return self._create_campaign_send_job_oapg(
            body=body,
