...
# body param
SchemaForRequestBodyApplicationJson = TagListOp


request_body_tag_list_op = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_tag_relationships_lists_oapg(
        self,
    ...
    def _create_tag_relationships_lists_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_list_op.serialize(body, content_type)
...
class CreateTagRelationshipsLists(BaseApi):
    ...
    def create_tag_relationships_lists(
        ...
        return self._create_tag_relationships_lists_oapg(
            body=body,
