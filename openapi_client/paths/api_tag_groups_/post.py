...
# body param
SchemaForRequestBodyApplicationJson = TagGroupCreateQuery


request_body_tag_group_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_tag_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_group_create_query.serialize(body, content_type)
...
class CreateTagGroup(BaseApi):
    ...
    def create_tag_group(
        ...
        return self._create_tag_group_oapg(
            body=body,
