...
# body param
SchemaForRequestBodyApplicationJson = CouponCodeCreateJobCreateQuery


request_body_coupon_code_create_job_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _spawn_coupon_code_bulk_create_job_oapg(
        self,
    ...
    def _spawn_coupon_code_bulk_create_job_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_coupon_code_create_job_create_query.serialize(body, content_type)
...
class SpawnCouponCodeBulkCreateJob(BaseApi):
    ...
    def spawn_coupon_code_bulk_create_job(
        ...
        return self._spawn_coupon_code_bulk_create_job_oapg(
            body=body,
