...
# body param
SchemaForRequestBodyApplicationJson = CampaignRecipientEstimationJobCreateQuery


request_body_campaign_recipient_estimation_job_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_campaign_recipient_estimation_job_oapg(
        self,
    ...
    def _create_campaign_recipient_estimation_job_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_recipient_estimation_job_create_query.serialize(body, content_type)
...
class CreateCampaignRecipientEstimationJob(BaseApi):
    ...
    def create_campaign_recipient_estimation_job(
        ...
        return self._create_campaign_recipient_estimation_job_oapg(
            body=body,
