...
# body param
SchemaForRequestBodyApplicationJson = PushTokenCreateQuery


request_body_push_token_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_push_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_push_token_create_query.serialize(body, content_type)
...
class CreatePushToken(BaseApi):
    ...
    def create_push_token(
        ...
        return self._create_push_token_oapg(
            body=body,
