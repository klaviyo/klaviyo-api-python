...
# body param
SchemaForRequestBodyApplicationJson = TemplateCloneQuery


request_body_template_clone_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_template_clone_oapg(
        self,
    ...
    def _create_template_clone_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_template_clone_query.serialize(body, content_type)
...
class CreateTemplateClone(BaseApi):
    ...
    def create_template_clone(
        ...
        return self._create_template_clone_oapg(
            body=body,
