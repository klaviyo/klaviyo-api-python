...
# body param
SchemaForRequestBodyApplicationJson = MetricAggregateQuery


request_body_metric_aggregate_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _query_metric_aggregates_oapg(
        self,
    ...
    def _query_metric_aggregates_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_metric_aggregate_query.serialize(body, content_type)
...
class QueryMetricAggregates(BaseApi):
    ...
    def query_metric_aggregates(
        ...
        return self._query_metric_aggregates_oapg(
            body=body,
