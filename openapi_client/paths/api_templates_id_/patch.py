...
# body param
SchemaForRequestBodyApplicationJson = TemplateUpdateQuery


request_body_template_update_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_template_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_template_update_query.serialize(body, content_type)
