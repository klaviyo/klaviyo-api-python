...
# body param
SchemaForRequestBodyApplicationJson = CampaignMessageAssignTemplateQuery


request_body_campaign_message_assign_template_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_campaign_message_assign_template_oapg(
        self,
    ...
    def _create_campaign_message_assign_template_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_message_assign_template_query.serialize(body, content_type)
...
class CreateCampaignMessageAssignTemplate(BaseApi):
    ...
    def create_campaign_message_assign_template(
        ...
        return self._create_campaign_message_assign_template_oapg(
            body=body,
