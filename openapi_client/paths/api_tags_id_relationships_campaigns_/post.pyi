...
# body param
SchemaForRequestBodyApplicationJson = TagCampaignOp


request_body_tag_campaign_op = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_tag_relationships_campaigns_oapg(
        self,
    ...
    def _create_tag_relationships_campaigns_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_campaign_op.serialize(body, content_type)
...
class CreateTagRelationshipsCampaigns(BaseApi):
    ...
    def create_tag_relationships_campaigns(
        ...
        return self._create_tag_relationships_campaigns_oapg(
            body=body,
