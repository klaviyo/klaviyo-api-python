...
class AdditionalFieldsListSchema(
    schemas.ListSchema
):
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'additional-fields[list]': typing.Union[AdditionalFieldsListSchema, list, tuple, ],
...
request_query_additional_fields_list = api_client.QueryParameter(
    name="additional-fields[list]",
    style=api_client.ParameterStyle.FORM,
    schema=AdditionalFieldsListSchema,
)
...
class BaseApi(api_client.Api):
    ...
    def _get_list_oapg(
        ...
        for parameter in (
            request_query_additional_fields_list,
