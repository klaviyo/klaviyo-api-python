...
# body param
SchemaForRequestBodyApplicationJson = SubscriptionCreateJobCreateQuery


request_body_subscription_create_job_create_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _subscribe_profiles_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_subscription_create_job_create_query.serialize(body, content_type)
...
class SubscribeProfiles(BaseApi):
    ...
    def subscribe_profiles(
        ...
        return self._subscribe_profiles_oapg(
            body=body,
