...
class TemplateRenderQueryResourceObjectAttributes(BaseModel):
    ...
    """ # noqa: E501
    context: Union[str, Any] = Field(description="The context for the template render. This must be a JSON object which has values for any tags used in the template. See [this doc](https://help.klaviyo.com/hc/en-us/articles/4408802648731) for more details.")
