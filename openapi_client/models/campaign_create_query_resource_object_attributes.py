...
class CampaignCreateQueryResourceObjectAttributes(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "campaign-messages": CampaignCreateQueryResourceObjectAttributesCampaignMessages.from_dict(obj.get("campaign-messages")) if obj.get("campaign-messages") is not None else None
        })
        return _obj
