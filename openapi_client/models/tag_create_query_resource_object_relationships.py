...
class TagCreateQueryResourceObjectRelationships(BaseModel):
    ...
    """ # noqa: E501
    tag_group: Optional[TagCreateQueryResourceObjectRelationshipsTagGroup] = Field(default=None, alias="tag-group")
    __properties: ClassVar[List[str]] = ["tag-group"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tag-group": TagCreateQueryResourceObjectRelationshipsTagGroup.from_dict(obj.get("tag-group")) if obj.get("tag-group") is not None else None
        })
        return _obj
