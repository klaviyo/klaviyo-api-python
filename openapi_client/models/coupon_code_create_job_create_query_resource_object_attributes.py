...
class CouponCodeCreateJobCreateQueryResourceObjectAttributes(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "coupon-codes": CouponCodeCreateJobCreateQueryResourceObjectAttributesCouponCodes.from_dict(obj.get("coupon-codes")) if obj.get("coupon-codes") is not None else None
        })
        return _obj
