...
class ProfileSubscriptionCreateQueryResourceObjectAttributes(BaseModel):
    ...
    phone_number: Optional[StrictStr] = Field(default=None, description="The phone number to subscribe or to set on the profile if `channels` is specified and the SMS channel is omitted.")
