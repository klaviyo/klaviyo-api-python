...
class PostProfileMergeResponseData(BaseModel):
    """
    PostProfileMergeResponseData
    """ # noqa: E501
    type: ProfileEnum
    id: StrictStr = Field(description="The ID of the destination profile that was merged into")
    links: ObjectLinks
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostProfileMergeResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostProfileMergeResponseData from a dict"""
        if obj is None:
            return None
