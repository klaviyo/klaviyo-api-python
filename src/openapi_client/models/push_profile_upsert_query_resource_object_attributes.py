...
class PushProfileUpsertQueryResourceObjectAttributes(BaseModel):
    """
    ...
    anonymous_id: Optional[StrictStr] = Field(default=None, description="Id that can be used to identify a profile when other identifiers are not available")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PushProfileUpsertQueryResourceObjectAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PushProfileUpsertQueryResourceObjectAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "meta": ProfileMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "email": obj.get("email")
        })
        return _obj
