...
class PostCouponCodeResponseDataRelationshipsProfile(BaseModel):
    """
    PostCouponCodeResponseDataRelationshipsProfile
    """ # noqa: E501
    data: Optional[PostCouponCodeResponseDataRelationshipsProfileData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostCouponCodeResponseDataRelationshipsProfile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostCouponCodeResponseDataRelationshipsProfile from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": PostCouponCodeResponseDataRelationshipsProfileData.from_dict(obj["data"]) if obj.get("data") is not None else None,
