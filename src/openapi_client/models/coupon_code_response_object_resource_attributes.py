...
class CouponCodeResponseObjectResourceAttributes(BaseModel):
    """
    CouponCodeResponseObjectResourceAttributes
    """ # noqa: E501
    unique_code: Optional[StrictStr] = Field(default=None, description="This is a unique string that will be or is assigned to each customer/profile and is associated with a coupon.")
    ...
    status: Optional[StrictStr] = Field(default=None, description="The current status of the coupon code.")
    __properties: ClassVar[List[str]] = ["unique_code", "expires_at", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CouponCodeResponseObjectResourceAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CouponCodeResponseObjectResourceAttributes from a dict"""
        if obj is None:
            return None
