...
class CampaignResponseObjectResource(BaseModel):
    """
    ...
    relationships: Optional[CampaignResponseObjectResourceRelationships] = None
    links: ObjectLinks
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CampaignResponseObjectResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CampaignResponseObjectResource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "relationships": CampaignResponseObjectResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
