...
class PostCustomMetricResponseData(BaseModel):
    """
    PostCustomMetricResponseData
    """ # noqa: E501
    ...
    relationships: Optional[CustomMetricResponseObjectResourceRelationships] = None
    links: ObjectLinks
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostCustomMetricResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostCustomMetricResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "relationships": CustomMetricResponseObjectResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
