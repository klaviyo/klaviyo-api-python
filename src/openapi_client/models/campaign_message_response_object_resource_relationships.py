...
class CampaignMessageResponseObjectResourceRelationships(BaseModel):
    """
    CampaignMessageResponseObjectResourceRelationships
    """ # noqa: E501
    ...
    image: Optional[CampaignMessageResponseObjectResourceRelationshipsImage] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CampaignMessageResponseObjectResourceRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CampaignMessageResponseObjectResourceRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "image": CampaignMessageResponseObjectResourceRelationshipsImage.from_dict(obj["image"]) if obj.get("image") is not None else None
        })
        return _obj
