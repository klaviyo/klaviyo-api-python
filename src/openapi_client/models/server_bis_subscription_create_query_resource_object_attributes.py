...
class ServerBISSubscriptionCreateQueryResourceObjectAttributes(BaseModel):
    ...
    """ # noqa: E501
    channels: List[StrictStr] = Field(description="The channel(s) through which the profile would like to receive the back in stock notification. This can be leveraged within a back in stock flow to notify the subscriber through their preferred channel(s).")
    profile: Optional[ServerBISSubscriptionCreateQueryResourceObjectAttributesProfile] = None
    __properties: ClassVar[List[str]] = ["channels", "profile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profile": ServerBISSubscriptionCreateQueryResourceObjectAttributesProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None
        })
        return _obj
