...
class WebhookTopicResponseObjectResource(BaseModel):
    """
    WebhookTopicResponseObjectResource
    """ # noqa: E501
    type: WebhookTopicEnum
    id: StrictStr = Field(description="The ID of the webhook topic.")
    links: ObjectLinks
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookTopicResponseObjectResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookTopicResponseObjectResource from a dict"""
        if obj is None:
            return None
