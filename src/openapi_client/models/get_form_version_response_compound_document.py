...
class GetFormVersionResponseCompoundDocument(BaseModel):
    """
    GetFormVersionResponseCompoundDocument
    """ # noqa: E501
    data: FormVersionResponseObjectResource
    included: Optional[List[FormResponseObjectResource]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetFormVersionResponseCompoundDocument from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetFormVersionResponseCompoundDocument from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": FormVersionResponseObjectResource.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "included": [FormResponseObjectResource.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
