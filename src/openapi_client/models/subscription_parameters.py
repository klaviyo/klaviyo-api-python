...
class SubscriptionParameters(BaseModel):
    """
    SubscriptionParameters
    """ # noqa: E501
    consent: StrictStr = Field(description="The Consent status to be set as part of the subscribe call. Currently supports \"SUBSCRIBED\".")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionParameters from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionParameters from a dict"""
        if obj is None:
            return None
