...
class GetWebhookTopicResponseCollection(BaseModel):
    """
    GetWebhookTopicResponseCollection
    """ # noqa: E501
    data: List[WebhookTopicResponseObjectResource]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetWebhookTopicResponseCollection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetWebhookTopicResponseCollection from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [WebhookTopicResponseObjectResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
