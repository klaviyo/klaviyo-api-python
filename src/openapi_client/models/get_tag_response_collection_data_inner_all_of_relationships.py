...
class GetTagResponseCollectionDataInnerAllOfRelationships(BaseModel):
    ...
    """ # noqa: E501
    tag_group: Optional[GetPhotosDTOCollectionDataInnerAllOfRelationshipsTestPhotographers] = Field(default=None, alias="tag-group")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tag-group": GetPhotosDTOCollectionDataInnerAllOfRelationshipsTestPhotographers.from_dict(obj["tag-group"]) if obj.get("tag-group") is not None else None,
