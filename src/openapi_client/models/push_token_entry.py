...
class PushTokenEntry(BaseModel):
    ...
    platform: StrictStr = Field(description="The platform on which the push token was created. Either \"ios\" or \"android\".")
    vendor: StrictStr = Field(description="The vendor of the push token. Either \"apns\" or \"fcm\".")
    enablement_status: Optional[StrictStr] = Field(default=None, description="The enablement status for the push token.")
    background: Optional[StrictStr] = Field(default=None, description="The background state of the push token.")
    device_metadata: Optional[PushTokenDeviceMetadata] = None
    __properties: ClassVar[List[str]] = ["token", "platform", "vendor", "enablement_status", "background", "device_metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PushTokenEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PushTokenEntry from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "device_metadata": PushTokenDeviceMetadata.from_dict(obj["device_metadata"]) if obj.get("device_metadata") is not None else None
        })
        return _obj
