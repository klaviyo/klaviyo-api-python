...
class TagResponseObjectResourceRelationships(BaseModel):
    """
    TagResponseObjectResourceRelationships
    """ # noqa: E501
    tag_group: Optional[TagResponseObjectResourceRelationshipsTagGroup] = Field(default=None, alias="tag-group")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TagResponseObjectResourceRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TagResponseObjectResourceRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "tag-group": TagResponseObjectResourceRelationshipsTagGroup.from_dict(obj["tag-group"]) if obj.get("tag-group") is not None else None,
