...
class GetFlowActionResponseCollection(BaseModel):
    """
    GetFlowActionResponseCollection
    """ # noqa: E501
    data: List[GetFlowActionResponseCollectionDataInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetFlowActionResponseCollection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetFlowActionResponseCollection from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [GetFlowActionResponseCollectionDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
