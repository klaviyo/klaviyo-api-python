...
class Visibility(BaseModel):
    ...
    is_code_only: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["check", "definition", "is_code_only"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if is_code_only (nullable) is None
        # and model_fields_set contains the field
        if self.is_code_only is None and "is_code_only" in self.model_fields_set:
            _dict['is_code_only'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_code_only": obj.get("is_code_only")
        })
        return _obj
