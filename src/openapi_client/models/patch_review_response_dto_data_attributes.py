...
class PatchReviewResponseDTODataAttributes(BaseModel):
    """
    PatchReviewResponseDTODataAttributes
    """ # noqa: E501
    email: StrictStr = Field(description="The email of the author of this review")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchReviewResponseDTODataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchReviewResponseDTODataAttributes from a dict"""
        if obj is None:
            return None
