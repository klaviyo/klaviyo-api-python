...
class CatalogItemResponseObjectResourceAttributes(BaseModel):
    """
    CatalogItemResponseObjectResourceAttributes
    """ # noqa: E501
    external_id: Optional[StrictStr] = Field(default=None, description="The ID of the catalog item in an external system.")
    ...
    created: Optional[datetime] = Field(default=None, description="Date and time when the catalog item was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).")
    updated: Optional[datetime] = Field(default=None, description="Date and time when the catalog item was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).")
    __properties: ClassVar[List[str]] = ["external_id", "title", "description", "price", "url", "image_full_url", "image_thumbnail_url", "images", "custom_metadata", "published", "created", "updated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CatalogItemResponseObjectResourceAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CatalogItemResponseObjectResourceAttributes from a dict"""
        if obj is None:
            return None
