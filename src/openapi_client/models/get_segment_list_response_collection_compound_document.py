...
class GetSegmentListResponseCollectionCompoundDocument(BaseModel):
    """
    GetSegmentListResponseCollectionCompoundDocument
    """ # noqa: E501
    data: List[GetSegmentListResponseCollectionCompoundDocumentDataInner]
    links: Optional[CollectionLinks] = None
    included: Optional[List[TagResponseObjectResource]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSegmentListResponseCollectionCompoundDocument from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSegmentListResponseCollectionCompoundDocument from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [GetSegmentListResponseCollectionCompoundDocumentDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "links": CollectionLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "included": [TagResponseObjectResource.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None
        })
        return _obj
