...
class GetEventResponseCollectionCompoundDocument(BaseModel):
    """
    GetEventResponseCollectionCompoundDocument
    """ # noqa: E501
    data: List[GetEventResponseCollectionCompoundDocumentDataInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetEventResponseCollectionCompoundDocument from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetEventResponseCollectionCompoundDocument from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [GetEventResponseCollectionCompoundDocumentDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
