...
class WebFeedPartialUpdateQueryResourceObjectAttributes(BaseModel):
    """
    WebFeedPartialUpdateQueryResourceObjectAttributes
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of this web feed")
    url: Optional[StrictStr] = Field(default=None, description="The URL of the web feed")
    request_method: Optional[StrictStr] = Field(default=None, description="The HTTP method for requesting the web feed")
    content_type: Optional[StrictStr] = Field(default=None, description="The content-type of the web feed")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebFeedPartialUpdateQueryResourceObjectAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebFeedPartialUpdateQueryResourceObjectAttributes from a dict"""
        if obj is None:
            return None
