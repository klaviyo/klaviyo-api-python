...
class ListListResponseObjectResourceRelationshipsProfiles(BaseModel):
    """
    ListListResponseObjectResourceRelationshipsProfiles
    """ # noqa: E501
    data: Optional[List[ListListResponseObjectResourceRelationshipsProfilesDataInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListListResponseObjectResourceRelationshipsProfiles from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListListResponseObjectResourceRelationshipsProfiles from a dict"""
        if obj is None:
            return None
