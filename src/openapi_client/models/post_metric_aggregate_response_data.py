...
class PostMetricAggregateResponseData(BaseModel):
    """
    PostMetricAggregateResponseData
    """ # noqa: E501
    type: MetricAggregateEnum
    id: StrictStr = Field(description="Ephemeral ID associated with the aggregation query")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostMetricAggregateResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostMetricAggregateResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": PostMetricAggregateResponseDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
