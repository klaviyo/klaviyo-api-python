...
class SMSChannel(BaseModel):
    ...
    SMSChannel
    """ # noqa: E501
    marketing: Optional[SMSMarketing] = None
    transactional: Optional[SMSTransactional] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "marketing": SMSMarketing.from_dict(obj["marketing"]) if obj.get("marketing") is not None else None,
            "transactional": SMSTransactional.from_dict(obj["transactional"]) if obj.get("transactional") is not None else None
        })
        return _obj
