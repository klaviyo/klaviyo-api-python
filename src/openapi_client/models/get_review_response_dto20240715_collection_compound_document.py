...
class GetReviewResponseDTO20240715CollectionCompoundDocument(BaseModel):
    """
    GetReviewResponseDTO20240715CollectionCompoundDocument
    """ # noqa: E501
    data: List[GetReviewResponseDTO20240715CollectionCompoundDocumentDataInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetReviewResponseDTO20240715CollectionCompoundDocument from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetReviewResponseDTO20240715CollectionCompoundDocument from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [GetReviewResponseDTO20240715CollectionCompoundDocumentDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
