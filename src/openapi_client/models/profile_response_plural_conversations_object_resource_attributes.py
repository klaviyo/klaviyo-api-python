...
class ProfileResponsePluralConversationsObjectResourceAttributes(BaseModel):
    """
    ProfileResponsePluralConversationsObjectResourceAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["email", "phone_number", "external_id", "first_name", "last_name", "organization", "locale", "title", "image", "created", "updated", "last_event_date", "location", "properties"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProfileResponsePluralConversationsObjectResourceAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProfileResponsePluralConversationsObjectResourceAttributes from a dict"""
        if obj is None:
            return None
