...
class ListMemberResponseObjectResourceAttributes(BaseModel):
    """
    ...
    joined_group_at: datetime = Field(description="The datetime when this profile most recently joined the list.")
    __properties: ClassVar[List[str]] = ["email", "phone_number", "external_id", "first_name", "last_name", "organization", "locale", "title", "image", "created", "updated", "last_event_date", "location", "properties", "joined_group_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListMemberResponseObjectResourceAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListMemberResponseObjectResourceAttributes from a dict"""
        if obj is None:
            return None
