...
class GetCouponResponse(BaseModel):
    """
    GetCouponResponse
    """ # noqa: E501
    data: Optional[CouponResponseObjectResource]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCouponResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCouponResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": CouponResponseObjectResource.from_dict(obj["data"]) if obj.get("data") is not None else None,
