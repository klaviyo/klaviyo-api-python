...
class ErrorSource(BaseModel):
    ...
    ErrorSource
    """ # noqa: E501
    pointer: Optional[StrictStr] = Field(default='/data', description="A pointer to the source of the error in the request payload.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pointer": obj.get("pointer") if obj.get("pointer") is not None else '/data'
        })
        return _obj
