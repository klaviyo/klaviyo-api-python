...
class CampaignMessageResponseObjectResourceAttributes(BaseModel):
    ...
    """ # noqa: E501
    label: Optional[StrictStr] = Field(description="The label or name on the message")
    channel: Optional[StrictStr] = Field(description="The channel the message is to be sent on")
