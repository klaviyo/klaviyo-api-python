...
class PhotosDTOObjectResourceAttributes(BaseModel):
    """
    PhotosDTOObjectResourceAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["title", "location", "date_taken", "datetime_taken", "exif", "non_filterable_photo_field"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PhotosDTOObjectResourceAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PhotosDTOObjectResourceAttributes from a dict"""
        if obj is None:
            return None
