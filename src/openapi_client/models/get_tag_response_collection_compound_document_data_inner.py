...
class GetTagResponseCollectionCompoundDocumentDataInner(BaseModel):
    """
    ...
    links: ObjectLinks
    relationships: Optional[GetTagResponseCollectionCompoundDocumentDataInnerAllOfRelationships] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTagResponseCollectionCompoundDocumentDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTagResponseCollectionCompoundDocumentDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "relationships": GetTagResponseCollectionCompoundDocumentDataInnerAllOfRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
