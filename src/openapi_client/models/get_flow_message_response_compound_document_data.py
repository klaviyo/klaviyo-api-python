...
class GetFlowMessageResponseCompoundDocumentData(BaseModel):
    """
    ...
    links: ObjectLinks
    relationships: Optional[GetFlowMessageResponseCompoundDocumentDataAllOfRelationships] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetFlowMessageResponseCompoundDocumentData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetFlowMessageResponseCompoundDocumentData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": FlowMessageResponseObjectResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "links": ObjectLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "relationships": GetFlowMessageResponseCompoundDocumentDataAllOfRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
