...
class GetFlowActionEncodedResponseCollectionDataInner(BaseModel):
    """
    GetFlowActionEncodedResponseCollectionDataInner
    """ # noqa: E501
    type: FlowActionEnum
    id: StrictStr
    attributes: FlowActionEncodedResponseObjectResourceAttributes
    links: ObjectLinks
    relationships: Optional[GetFlowActionEncodedResponseCollectionDataInnerAllOfRelationships] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetFlowActionEncodedResponseCollectionDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetFlowActionEncodedResponseCollectionDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "relationships": GetFlowActionEncodedResponseCollectionDataInnerAllOfRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
