...
class FlowActionEncodedResponseObjectResourceRelationshipsFlowMessages(BaseModel):
    """
    FlowActionEncodedResponseObjectResourceRelationshipsFlowMessages
    """ # noqa: E501
    data: Optional[List[FlowActionEncodedResponseObjectResourceRelationshipsFlowMessagesDataInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FlowActionEncodedResponseObjectResourceRelationshipsFlowMessages from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FlowActionEncodedResponseObjectResourceRelationshipsFlowMessages from a dict"""
        if obj is None:
            return None
