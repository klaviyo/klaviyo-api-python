...
class GetFlowMessageEncodedResponseCollectionDataInner(BaseModel):
    """
    GetFlowMessageEncodedResponseCollectionDataInner
    """ # noqa: E501
    type: FlowMessageEnum
    id: StrictStr
    attributes: FlowMessageEncodedResponseObjectResourceAttributes
    links: ObjectLinks
    relationships: Optional[GetFlowMessageEncodedResponseCollectionDataInnerAllOfRelationships] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetFlowMessageEncodedResponseCollectionDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetFlowMessageEncodedResponseCollectionDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "relationships": GetFlowMessageEncodedResponseCollectionDataInnerAllOfRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
