...
class GetFlowMessageEncodedResponseCompoundDocumentData(BaseModel):
    """
    GetFlowMessageEncodedResponseCompoundDocumentData
    """ # noqa: E501
    type: FlowMessageEnum
    id: StrictStr
    attributes: FlowMessageEncodedResponseObjectResourceAttributes
    links: ObjectLinks
    relationships: Optional[GetFlowMessageEncodedResponseCompoundDocumentDataAllOfRelationships] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetFlowMessageEncodedResponseCompoundDocumentData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetFlowMessageEncodedResponseCompoundDocumentData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "relationships": GetFlowMessageEncodedResponseCompoundDocumentDataAllOfRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
