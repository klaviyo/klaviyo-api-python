...
class ImportErrorResponseObjectResourceAttributes(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImportErrorResponseObjectResourceAttributes from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.original_payload is None and "original_payload" in self.model_fields_set:
            _dict['original_payload'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImportErrorResponseObjectResourceAttributes from a dict"""
        if obj is None:
            return None
