...
class OpenTrackingConsent(BaseModel):
    """
    OpenTrackingConsent
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["consent", "consent_timestamp", "last_updated", "created_timestamp", "metadata", "can_receive", "valid_until"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenTrackingConsent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenTrackingConsent from a dict"""
        if obj is None:
            return None
