...
class WebhookResponseObjectResource(BaseModel):
    """
    ...
    relationships: Optional[WebhookResponseObjectResourceRelationships] = None
    links: ObjectLinks
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookResponseObjectResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookResponseObjectResource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "relationships": WebhookResponseObjectResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
