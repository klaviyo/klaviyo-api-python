...
class PushTokenDeviceMetadata(BaseModel):
    """
    ...
    def klaviyo_sdk_validate_enum(cls, value):
        ...
        if value not in set(['android', 'flutter', 'flutter_community', 'react_native', 'swift']):
            raise ValueError("must be one of enum values ('android', 'flutter', 'flutter_community', 'react_native', 'swift')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PushTokenDeviceMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PushTokenDeviceMetadata from a dict"""
        if obj is None:
            return None
