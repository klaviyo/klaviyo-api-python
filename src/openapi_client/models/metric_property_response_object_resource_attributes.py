...
class MetricPropertyResponseObjectResourceAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["label", "property", "inferred_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetricPropertyResponseObjectResourceAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetricPropertyResponseObjectResourceAttributes from a dict"""
        if obj is None:
            return None
