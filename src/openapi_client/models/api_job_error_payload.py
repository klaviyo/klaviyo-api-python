...
class APIJobErrorPayload(BaseModel):
    """
    APIJobErrorPayload
    """ # noqa: E501
    ...
    source: ErrorSource
    __properties: ClassVar[List[str]] = ["id", "code", "title", "detail", "source"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of APIJobErrorPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of APIJobErrorPayload from a dict"""
        if obj is None:
            return None
