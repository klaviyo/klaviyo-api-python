...
class WhatsAppUnsubscriptionParameters(BaseModel):
    """
    ...
    conversational: Optional[UnsubscriptionParameters] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WhatsAppUnsubscriptionParameters from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WhatsAppUnsubscriptionParameters from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "conversational": UnsubscriptionParameters.from_dict(obj["conversational"]) if obj.get("conversational") is not None else None
        })
        return _obj
