...
class GetFlowActionEncodedResponseCompoundDocumentDataAllOfRelationships(BaseModel):
    """
    GetFlowActionEncodedResponseCompoundDocumentDataAllOfRelationships
    """ # noqa: E501
    flow: Optional[GetFlowActionEncodedResponseCompoundDocumentDataAllOfRelationshipsFlow] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetFlowActionEncodedResponseCompoundDocumentDataAllOfRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetFlowActionEncodedResponseCompoundDocumentDataAllOfRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "flow": GetFlowActionEncodedResponseCompoundDocumentDataAllOfRelationshipsFlow.from_dict(obj["flow"]) if obj.get("flow") is not None else None,
