...
class GetCouponCodeResponseCollectionDataInnerAllOfRelationships(BaseModel):
    ...
    """ # noqa: E501
    coupon: Optional[GetCouponCodeResponseCollectionCompoundDocumentDataInnerAllOfRelationshipsProfile] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "coupon": GetCouponCodeResponseCollectionCompoundDocumentDataInnerAllOfRelationshipsProfile.from_dict(obj["coupon"]) if obj.get("coupon") is not None else None,
