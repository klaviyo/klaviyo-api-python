...
class FlowActionEncodedResponseObjectResourceRelationships(BaseModel):
    """
    FlowActionEncodedResponseObjectResourceRelationships
    """ # noqa: E501
    flow: Optional[FlowActionEncodedResponseObjectResourceRelationshipsFlow] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FlowActionEncodedResponseObjectResourceRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FlowActionEncodedResponseObjectResourceRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "flow": FlowActionEncodedResponseObjectResourceRelationshipsFlow.from_dict(obj["flow"]) if obj.get("flow") is not None else None,
