...
class GetFlowV2ResponseCompoundDocumentData(BaseModel):
    """
    GetFlowV2ResponseCompoundDocumentData
    """ # noqa: E501
    type: FlowEnum
    id: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetFlowV2ResponseCompoundDocumentData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetFlowV2ResponseCompoundDocumentData from a dict"""
        if obj is None:
            return None
