...
class PostProfileImportJobResponseData(BaseModel):
    ...
    relationships: Optional[PostProfileImportJobResponseDataRelationships] = None
    links: ObjectLinks
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": PostProfileImportJobResponseDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
