...
class GetFlowActionEncodedResponseCompoundDocumentDataAllOfRelationshipsFlow(BaseModel):
    """
    GetFlowActionEncodedResponseCompoundDocumentDataAllOfRelationshipsFlow
    """ # noqa: E501
    data: Optional[GetMetricResponseCollectionCompoundDocumentDataInnerAllOfRelationshipsFlowTriggersDataInner] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetFlowActionEncodedResponseCompoundDocumentDataAllOfRelationshipsFlow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetFlowActionEncodedResponseCompoundDocumentDataAllOfRelationshipsFlow from a dict"""
        if obj is None:
            return None
