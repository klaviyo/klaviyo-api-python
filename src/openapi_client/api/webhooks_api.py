...
class WebhooksApi(object):
    ...
    def get_webhook(        
        self,
        id: Annotated[StrictStr, Field(description="The ID of the webhook.")],
        fields_webhook: Annotated[Optional[List[StrictStr]], Field(description="For more information please visit https://developers.klaviyo.com/en/v2025-01-15/reference/api-overview#sparse-fieldsets")] = None,
        ...
        :param id: The ID of the webhook. (required)
        :type id: str
        :param fields_webhook: For more information please visit https://developers.klaviyo.com/en/v2025-01-15/reference/api-overview#sparse-fieldsets
