...
class TrackingSettingsApi(object):
    ...
    def get_tracking_setting(        
        ...
        fields_tracking_setting: Annotated[Optional[List[StrictStr]], Field(description="For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets")] = None,
        ...
        :type id: str
        :param fields_tracking_setting: For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets
